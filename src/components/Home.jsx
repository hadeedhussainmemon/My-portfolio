          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="order-2 lg:order-1 space-y-6 sm:space-y-8 animate-slideInLeft text-center lg:text-left">
                      ...
                      <div className="flex gap-2.5">
                        {[
                          ...
                          <a 
                            ...
                            href={social.href} 
                            className="w-9 h-9 sm:w-10 sm:h-10 glass rounded-xl flex items-center justify-center hover:bg-white/10 transition-all duration-300 hover:scale-110 shadow-lg border border-white/5 active:scale-95"
                          >
                ...
                <div className="flex flex-row items-center justify-center lg:justify-start gap-3 sm:gap-6 pt-6 sm:pt-8 w-full max-w-md mx-auto lg:mx-0">
                  <a href="#contact" className="flex-1 sm:flex-none group relative inline-flex items-center justify-center gap-2 sm:gap-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-5 sm:px-10 py-4 sm:py-5 rounded-xl sm:rounded-2xl hover:scale-[1.02] active:scale-[0.95] transition-all duration-500 shadow-2xl hover:shadow-blue-500/25 font-black uppercase tracking-widest text-[10px] sm:text-sm border border-white/10">
                    Hire Me
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                    </svg>
                  </a>
                  <a href="/cv/MyCV.pdf" download className="flex-1 sm:flex-none group inline-flex items-center justify-center gap-2 sm:gap-3 glass px-5 sm:px-10 py-4 sm:py-5 rounded-xl sm:rounded-2xl hover:bg-white/10 transition-all duration-500 font-black uppercase tracking-widest text-[10px] sm:text-sm border border-white/10 hover:border-blue-500/50 shadow-lg hover:scale-[1.02] active:scale-[0.95]">
                    Resume
