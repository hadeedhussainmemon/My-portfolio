        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-5 grid gap-8 lg:border-l lg:border-zinc-200 lg:pl-12">
            <div className="flex items-start gap-4">
              ...
              <div>
                <span className="block text-[9px] font-bold text-zinc-500 uppercase tracking-widest mb-1">Email</span>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <span className="block text-[9px] font-bold text-zinc-500 uppercase tracking-widest mb-1">Website</span>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <span className="block text-[9px] font-bold text-zinc-500 uppercase tracking-widest mb-1">Location</span>
