      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              className="md:hidden text-white hover:text-blue-400 transition-colors text-2xl" 
            ...
            <nav className="flex flex-col gap-4">
              {['Home', 'About', 'Skills', 'Qualification', 'Projects', 'Contact'].map((item, index) => (
                <a 
                  key={item}
                  href={`#${item.toLowerCase()}`}
                  className="text-gray-300 hover:text-white py-2 hover:pl-4 transition-all duration-300 border-l-2 border-transparent hover:border-blue-400"
